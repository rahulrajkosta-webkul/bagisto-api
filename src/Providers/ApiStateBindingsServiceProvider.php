...
class ApiStateBindingsServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->tag(AdminSettingsSectionCollectionProvider::class, ProviderInterface::class);
        $this->app->tag(AdminSettingsSectionItemProvider::class, ProviderInterface::class);
        $this->app->tag(AdminSettingsSectionWriteProvider::class, ProviderInterface::class);
        $this->app->tag(AdminSettingsSectionProcessor::class, ProcessorInterface::class);
        $this->app->tag(AdminSettingsSectionMassDeleteProcessor::class, ProcessorInterface::class);
        $this->app->tag(AdminSettingsSectionMassUpdateStatusProcessor::class, ProcessorInterface::class);
